...
public class OrderServiceImpl implements OrderService{
	...
	//마이페이지 주문내역 리스트 조회
		@Override
		public List<OrderCommand> selectMyOrderList(int memberNo, int startIndex, int pageSize) throws Exception {
			return orderDao.selectMyOrderList(memberNo, startIndex, pageSize);
		}
		//마이페이지 주문 상품 개수
		@Override
		public int selectAllCount(int memberNo) throws Exception {
			return orderDao.selectAllCount(memberNo);
		}
		//마이페이지 주문 상품 삭제
		@Override
		public int myOrderDelete(int memberNo, int historyNo) throws Exception {
			return orderDao.myOrderDelete(memberNo, historyNo);
		}	
