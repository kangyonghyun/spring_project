...
<body>
   ...
   <div class="gnbList">
      <ul class="clearfix">
         <li class="on"><a href="${path}/store/category?type=1">
               <div class="imgArea">
                  <img alt="" src="${path}/images/categorie01.jpg">
               </div>
               <div class="txt">가구</div>
         </a></li>
         <li><a href="${path}/store/category?type=2">
               <div class="imgArea">
                  <img alt="" src="${path}/images/categorie07.jpg">
               </div>
               <div class="txt">침구</div>
         </a></li>
         <li><a href="${path}/store/category?type=3">
               <div class="imgArea">
                  <img alt="" src="${path}/images/categorie02.jpg">
               </div>
               <div class="txt">패브릭</div>
         </a></li>
         <li><a href="${path}/store/category?type=4">
               <div class="imgArea">
                  <img alt="" src="${path}/images/categorie03.jpg">
               </div>
               <div class="txt">홈데코</div>
         </a></li>
         <li><a href="${path}/store/category?type=5">
               <div class="imgArea">
                  <img alt="" src="${path}/images/categorie04.jpg">
               </div>
               <div class="txt">가전</div>
         </a></li>
         <li><a href="${path }/store/category?type=6">
               <div class="imgArea">
                  <img alt="" src="${path }/images/categorie05.jpg">
               </div>
               <div class="txt">생활용품</div>
         </a></li>
         <li><a href="${path }/store/category?type=7">
               <div class="imgArea">
                  <img alt="" src="${path }/images/categorie06.jpg">
               </div>
            ...
            <c:forEach var="itemC" items="${itemPage.content}">
               <li onclick="javascript:moveItemViewPage('${path }','${itemC.item.itemNo} ','${path }${itemC.itemImg.thumbUrl}'); return false;">
                  <a>
                     ...
                     <div class="infoArea">
                        <p class="brand">
                           <c:out value="${itemC.categorie.categorieName}" />
                        </p>
                        <p class="ttl">
                           <c:out value="${itemC.item.itemName}" />
                        </p>
                        <p class="pdSum">
                           <c:out value="${itemC.item.price}" />원
                        </p>
                     </div>
                  </a>
               </li>
   ...
   <script type="text/javascript">
      ...
      function initLatelyViewItemList() {
         //로컬스토리지에서 latelyViewItemList로 저장된 정보가 있는지 확인후
         if (isNull(getItemLocalStorage('latelyViewItemList'))) {
            ...
            if (latelyViewItemListJson != "null" || isNull(latelyViewItemListJson)) {
               ...
               //상품 리스트를 돌면서 상품별 저장된 시간이 현재 시간보다 클경우만 다시 latelyViewItemListNew에 추가
               ...
               if (latelyViewItemListNew.length == 0) {
                  ...
                  setLocalStorage('latelyViewItemList', JSON
                        .stringify(latelyViewItemListNew));}}
      ...
      function moveItemViewPage(path, itemSeq, itemImagePath) {
         ...
         if (latelyViewItemListJson == "null"
               || isNull(latelyViewItemListJson)) {
            ...
            var latelyViewItem = {
               ...
               "viewTime" : viewTime.setDate(viewTime.getDate()
                     + Number(LATELY_VIEW_ITEM_EXPIRATION_DATE))
            }
      ...
      function LatelyViewItemRender(page) {
         ...
         if (getItemLocalStorage('latelyViewItemList') != "null"
               || isNull(getItemLocalStorage('latelyViewItemList'))) {

            var latelyViewItemList = JSON
                  .parse(getItemLocalStorage('latelyViewItemList'));
                              ...
                              $("<li>")
                                    .append(
                                          $("<a>")
                                                .attr(
                                                      "href",
                                                      "${pageContext.request.contextPath }/itemDetail?itemNo="
                                                            + latelyViewItemList[i].itemNo)
                                                .append(
                                                      $(
                                                            "<img>")
                                                            .attr(
                                                                  "src",
                                                                  latelyViewItemList[i].thumbUrl)
                                                            .attr(
                                                                  "alt",
                                                                  "최근본상품"))));
               }
      ...
      function latelyViewItemPageingPlusMinus(type) {
         ...
         if (type == "minus") {
            if (Number($("strong#nowLatelyViewItemPage_strong").text()) > 1) {
               $("strong#nowLatelyViewItemPage_strong").text(
                     Number($("strong#nowLatelyViewItemPage_strong")
                           .text()) - 1);
            ...
            if (Number($("strong#nowLatelyViewItemPage_strong").text()) < Number($(
                  "span#totalLatelyViewItemPage_span").text())) {
               $("strong#nowLatelyViewItemPage_strong").text(
                     Number($("strong#nowLatelyViewItemPage_strong")
                           .text()) + 1);
               LatelyViewItemRender($(
